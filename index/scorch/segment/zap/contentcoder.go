...
func newChunkedContentCoder(chunkSize uint64, maxDocNum uint64,
	w io.Writer, writeOutInChunks bool) *chunkedContentCoder {
	...
	rv := &chunkedContentCoder{
		...
		w:                w,
		writeOutInChunks: writeOutInChunks,
	}
